...
export function BudgetPage() {
    ...
    return (<>
      ...
      <div className="space-y-6 animate-in">
        ...
        {/* Alerts */}
        {overBudget.length > 0 && (<div className="finova-card bg-red-50 dark:bg-red-900/10 border-red-200 dark:border-red-800">
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 finova-card">
            ...
            return (<div key={budget.id} className="group">
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center gap-3">
                        <div className="w-9 h-9 rounded-xl flex items-center justify-center text-lg" style={{ background: `${budget.color}20` }}>
                          {budget.icon}
                        </div>
                        <div>
                      ...
                      <div className="flex items-center gap-2">
                        {isOver && (<span className="text-red-500 text-xs font-semibold">
                    ...
                    <ProgressBar value={budget.spent} max={budget.limit} color={budget.color} showLabel={false} height={10}/>
            ...
            {/* Add new budget row */}
            <button onClick={() => setShowModal(true)} className="mt-5 w-full py-3 rounded-xl border-2 border-dashed border-border hover:border-primary-500 text-muted-foreground hover:text-primary-500 transition-all flex items-center justify-center gap-2 text-sm font-medium">
              <Plus size={16}/>
              Add Another Budget
            </button>
          </div>
              ...
              <div className="text-center py-4">
                <div className="relative inline-flex items-center justify-center">
                  <svg className="w-28 h-28 -rotate-90" viewBox="0 0 36 36">
                    ...
                    <circle cx="18" cy="18" r="14" fill="none" stroke="#2563EB" strokeWidth="3" strokeDasharray={`${Math.max(0, 100 - (totalSpent / totalBudget) * 100) * 0.879} 100`} strokeLinecap="round"/>
                  </svg>
