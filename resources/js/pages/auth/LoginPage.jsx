      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5" noValidate>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input id="login-email" type="email" autoComplete="email" placeholder="you@example.com" className={`finova-input pl-10 ${errors.email ? 'border-destructive focus:ring-destructive' : ''}`} {...register('email')}/>
          </div>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input id="login-password" type={showPassword ? 'text' : 'password'} autoComplete="current-password" placeholder="Enter your password" className={`finova-input pl-10 pr-10 ${errors.password ? 'border-destructive focus:ring-destructive' : ''}`} {...register('password')}/>
        ...
        {/* Submit */}
        <LoadingButton type="submit" loading={login.isPending} fullWidth className="h-11 text-base">
          Sign In
        </LoadingButton>
      </form>
