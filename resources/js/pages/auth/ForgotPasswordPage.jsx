...
export function ForgotPasswordPage() {
    ...
    if (sent) {
        return (<div className="finova-card auth-glow text-center animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <p className="text-muted-foreground text-sm mb-6">
          ...
          <button type="button" onClick={() => setSent(false)} className="text-primary-500 hover:underline font-medium">
            try again
          </button>.
        </p>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5" noValidate>
        <div>
          ...
          <div className="relative">
            ...
            <input id="forgot-email" type="email" autoComplete="email" placeholder="you@example.com" className={`finova-input pl-10 ${errors.email ? 'border-destructive' : ''}`} {...register('email')}/>
          </div>
