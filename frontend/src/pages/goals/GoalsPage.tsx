          ...
          <div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {completed.map(g => (
                <div
                  key={g.id}
                  className="finova-card border-primary-500/30 bg-primary-50/30 dark:bg-primary-900/10 relative overflow-hidden"
                >
        ...
        <div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {active.map(g => {
              ...
              return (
                <div key={g.id} className="finova-card group relative hover:shadow-lg transition-all">
                  {/* Hover actions */}
                  ...
                  <div className="flex items-center justify-between pt-3 border-t border-border">
                    ...
                    <span className={`text-xs font-semibold flex items-center gap-1 ${
                      days < 30 ? 'text-red-500' : days < 90 ? 'text-amber-500' : 'text-muted-foreground'
                    }`}>
                      <Zap size={10} />
