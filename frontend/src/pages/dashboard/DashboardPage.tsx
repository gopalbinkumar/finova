...
import {
  ...
  ArrowDownRight, CreditCard, Calendar, Plus,
} from 'lucide-react'
import { Link } from 'react-router-dom'
import { useState } from 'react'
import { StatCard, ProgressBar, SectionHeader } from '@/components/ui/Cards'
import {
  mockAccounts, mockTransactions, mockBudgets, summaryStats,
  monthlyChartData, expenseCategoryData, cashFlowData, upcomingBills,
} from '@/data/mockData'
        ...
        <div className="space-y-6">
          ...
          <div className="finova-card">
            <SectionHeader
              ...
              action={<Link to="/budget" className="text-xs text-primary-500 hover:underline font-medium">View all →</Link>}
            />
