      ...
      <div className="finova-card">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {filtered.map((account) => (
            <div
              key={account.id}
              className="relative rounded-xl border border-border p-5 hover:border-primary-500/30 hover:shadow-md transition-all cursor-pointer group overflow-hidden"
            >
              {/* Gradient top strip */}
